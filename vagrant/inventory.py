...
# Dynamic inventory script which lets you use aliases from ./vagrant.ssh_config.
#
...
# 1.7.2 to 1.15.2.
#
# It prints inventory based on parsed ./vagrant.ssh_config. You can refer to hosts
